...
# Set foot position parameters for deliberate and pronounced leg movements
# set_foot_pos_parameters('front_left', 0.2, 0.1, None)
# set_foot_pos_parameters('back_left', 0.2, 0.1, None)
# set_foot_pos_parameters('front_right', 0.2, 0.1, None)
# set_foot_pos_parameters('back_right', 0.2, 0.1, None)
