...
"""Python client for interfacing with an MJPC binary running the Go1 task."""
...
class Go1State:
  """Current state of the Go1 robot from the MJPC binary."""
...
class Go1Client(task_clients.AgentApiTaskClient):
  """Client for controlling MJPC when it's running the Go1 task."""
