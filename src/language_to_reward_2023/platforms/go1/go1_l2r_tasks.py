...
"""Utilities for generating task parameters for the Go1 MJPC task."""

from typing import Literal

from language_to_reward_2023.platforms.go1 import default_task_parameters
...
def defaults() -> tuple[dict[str, float], dict[str, float]]:
  """Default cost weights and task parameters for the Go1 MJPC task."""
