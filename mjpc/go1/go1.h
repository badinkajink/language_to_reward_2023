...
#ifndef THIRD_PARTY_DEEPMIND_LANGUAGE_TO_REWARD_2023_MJPC_GO1_GO1_H_
#define THIRD_PARTY_DEEPMIND_LANGUAGE_TO_REWARD_2023_MJPC_GO1_GO1_H_
...
class Go1Flat : public mjpc::Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Go1Flat* task)
   ...
   private:
    ...
    constexpr static double kHeightQuadruped = 0.28;  // meter
...
class Go1Hill : public mjpc::Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Go1Hill* task, int current_mode = 0)
    ...
    void Residual(const mjModel* model, const mjData* data,
                  double* residual) const override;
   private:
    friend class Go1Hill;
    int current_mode_;
  };
  Go1Hill() : residual_(this) {}
  void TransitionLocked(mjModel* model, mjData* data) override;
...
#endif  // THIRD_PARTY_DEEPMIND_LANGUAGE_TO_REWARD_2023_MJPC_GO1_GO1_H_
